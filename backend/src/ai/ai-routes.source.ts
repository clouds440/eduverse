...
export const aiRouteEntries: AIRouteEntry[] = [
  ...
  {
    label: 'EduVerse Copilot Dashboard',
    href: '/ai',
    roles: ALL_ORG_ROLES,
    description: 'Personal AI usage, credits, and EduVerse Copilot usage dashboard. Org admins also see organization usage.',
    module: 'EduVerse Copilot',
  ...
  },
  {
    ...
    href: '/admissions',
    roles: ALL_ORG_ROLES,
    description: 'Provider-neutral public directory of open program offerings with filters for provider, type, subject, location, delivery, fee, intake, and deadline.',
    module: 'Admissions',
    tags: ['public admissions', 'apply online', 'program offerings', 'provider catalog', 'discover ready', 'no login'],
  },
  {
    label: 'Admissions Setup',
    href: '/admissions-setup',
    roles: [Role.ORG_ADMIN, Role.SUB_ADMIN, Role.ORG_MANAGER],
    description: 'Configure public offering listings, fees, funding, eligibility, admission forms, readiness, and publish/open/close lifecycle.',
    module: 'Admissions',
    tags: ['admissions setup', 'fees', 'eligibility', 'funding', 'application forms', 'offering readiness'],
  },
  {
    label: 'Sections',
    href: '/sections',
