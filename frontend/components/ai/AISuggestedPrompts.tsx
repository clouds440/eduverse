  ...
  return (
    <div className="flex min-w-0 items-center gap-1">
      <button
        ...
        className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-border/70 bg-card text-muted-foreground shadow-xs transition-colors hover:border-primary/30 hover:text-foreground disabled:pointer-events-none disabled:opacity-40"
      >
      ...
      >
        {visibleSuggestions.map((suggestion) => (
          <button
            ...
            className={cn(
              "shrink-0 max-w-fit cursor-pointer rounded-full border border-border/70 bg-card px-3 py-1.5 text-left text-xs font-bold leading-5 text-foreground shadow-xs transition-colors",
