...
import {
    ...
    UserMinus, Trash2, Info, SlidersHorizontal, ChevronLeft, ArrowDown, ArrowUp,
        ...
        `}>
                {activeChat ? (
                    <>
                        {/* Chat Header */}
                        <div
                            className="relative w-full px-3 sm:px-4 py-1.5 border-b border-border/60 flex items-center justify-between z-20 bg-background/95 shadow-sm shadow-foreground/5"
                        >
                            <button
                                type="button"
