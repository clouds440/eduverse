...
export function ProfanityWarningDialog({
  warning,
  onClose,
}: ProfanityWarningDialogProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-500 flex items-center justify-center overflow-y-auto bg-(--app-surface-overlay) p-3 backdrop-blur-sm sm:p-6">
      <div
        ref={dialogRef}
        role="dialog"
        aria-modal="true"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              {warning.message ||
                "Please revise the highlighted text before submitting again."}
            </p>
            {warning.field && (
