...
(function () {
  try {
    ...
    root.style.setProperty('--card-bg', isDark ? '#121826' : '#EEF2F7');
    ...
    root.style.setProperty('--input-bg', isDark ? '#0F172A' : '#F1F5F9');
    root.style.setProperty('--navbar-bg', isDark ? 'rgba(17, 24, 39, 0.9)' : 'rgba(226, 232, 240, 0.92)');
