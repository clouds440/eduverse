...
import { formatBuildingLabel, formatDepartmentLabel, formatRoomLabel } from '@/lib/utils';
...
export default function RoomsPage() {
    ...
    const handleSubmit = async (event: FormEvent) => {
        ...
        try {
            ...
            if (editingRoom) {
                await api.org.updateRoom(editingRoom.id, payload, token);
                dispatch({ type: 'TOAST_ADD', payload: { message: 'Room updated', type: 'success' } });
            } else {
                await api.org.createRoom(payload, token);
        ...
        <PageShell>
            ...
            <ResourcePanel>
                <FilterDrawerToolbar
                    ...
                    leading={<SearchBar value={searchTerm} onChange={(value) => updateQueryParams({ search: value, page: 1 })} placeholder="Search rooms..." />}
