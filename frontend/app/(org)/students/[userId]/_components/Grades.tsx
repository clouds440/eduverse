    ...
    return (
        <div className="space-y-4">
            ...
            {filteredGrades.length === 0 ? (
                <EmptyState
                    icon={Trophy}
                    title={grades.length === 0 ? 'No grades published' : 'No grades found'}
                    description={grades.length === 0 ? 'Published grades will appear here when available.' : 'Try another course, section, or grade.'}
                    className="min-h-80"
                />
            ) : (
